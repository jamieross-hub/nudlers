...
async function updateSettings() {
    ...
    try {
        ...
        const descriptionUpdates = [
            ...
            ['ai_base_url', 'Base URL of an OpenAI-compatible AI provider (default: OpenRouter)'],
            ['ai_api_key', 'API key (Bearer token) for the configured AI provider'],
            ['ai_model', 'Model identifier (provider-specific slug, e.g. google/gemini-2.5-flash)'],
            ['ai_extra_headers', 'Optional JSON object of extra HTTP headers sent on every AI request'],
